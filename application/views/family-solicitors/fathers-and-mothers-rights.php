...
$data = ['section1' => 'childrens-issues', 'section2' => 'fathers-and-mothers-rights'];
?>

<div id="content" class="site-content">
  <div id="primary" class="content-area">
    <?php $this->load->view('layout/home-banner', ["banner_path"=>"./wp-content/uploads/2021/02/Divorce-Children-Family-Law.jpg", "header_name" => "Fathers’ & Mothers’ Rights"]); ?>     
    <div class="bg-grey">
      <div class="container">
